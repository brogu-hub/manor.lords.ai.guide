          ...
          {hasResponse ? (
            ...
            <div className="flex items-center gap-3 py-2">
              <div className="flex gap-1.5">
                <span className="w-2 h-2 rounded-full bg-primary animate-pulse-gold" style={{ animationDelay: "0s" }} />
                <span className="w-2 h-2 rounded-full bg-primary animate-pulse-gold" style={{ animationDelay: "0.3s" }} />
                <span className="w-2 h-2 rounded-full bg-primary animate-pulse-gold" style={{ animationDelay: "0.6s" }} />
              </div>
